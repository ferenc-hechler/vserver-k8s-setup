...
## add ingress for vault.vps-2.cluster-4.de
...
```
# set VAULT_ADDR=https://vault.vps-2.cluster-4.de
export VAULT_ADDR=https://vault.vps-2.cluster-4.de
...
$ vault login -agent-address=https://vault.vps-2.cluster-4.de -method=userpass username=webapp
