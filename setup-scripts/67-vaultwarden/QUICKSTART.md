...
```bash
cd setup-scripts/67-vaultwarden
...
2. Or via values.yaml:
   ...
   - Run: `helm upgrade vaultwarden -n vaultwarden --values 67-vaultwarden/values.yaml gissilabs/vaultwarden`
...
```
setup-scripts/
├── 67-vaultwarden.sh                      # Main installation script
└── 67-vaultwarden/
