...
#sudo nohup socat TCP-LISTEN:61441,fork TCP:$CLUSTER_IP:$CLUSTER_PORT  >/dev/null 2>&1 &
...
sudo nohup socat TCP-LISTEN:61441,fork TCP:$PUBLIC_IP:$MINECRAFT_SVC_NODEPORT  >/dev/null 2>&1 &
